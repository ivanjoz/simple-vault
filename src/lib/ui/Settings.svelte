...
>
	...
	>
		...
		{#if vault.error}
			<p class="mt-3 text-xs text-danger">{vault.error}</p>
		{/if}
		...
		<section class="mt-6 border-t border-border pt-5">
			...
			<p class="mt-1 text-xs text-muted">Rotates the key and re-encrypts everything.</p>
		...
		<section class="mt-6 border-t border-border pt-5">
			...
			<p class="mt-1 text-xs text-muted">Generate a new key; the old one stops working.</p>
			<div class="mt-3">
		...
		<section class="mt-6 border-t border-border pt-5">
			...
			<p class="mt-1 text-xs text-muted">The export is encrypted; import replaces this device's vault.</p>
